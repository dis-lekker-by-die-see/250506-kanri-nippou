...
document.addEventListener("DOMContentLoaded", () => {
    ...
    downloadBtn.addEventListener("click", () => {
        ...
        const table1Inputs = tables[0].querySelectorAll("input.form-input");
        tableData["table1"] = {
        ...
        const table2Inputs = tables[1].querySelectorAll("input.form-input");
        tableData["table2"] = {
        ...
        // Table 3: 注意事項
        const table3Inputs = tables[2].querySelectorAll("input.form-input");
        tableData["table3"] = {
            注意事項: [
                {
        ...
        // Table 4: 時間, 確認者, etc.
        const table4Inputs = tables[3].querySelectorAll("input.form-input");
        tableData["table4"] = {
            段ボール: {
        ...
        // Table 5: 出来高, 数量, 時間
        const table5Inputs = tables[4].querySelectorAll("input.form-input");
        tableData["table5"] = {
        ...
        // Table 6: バッチ
        const table6Inputs = tables[5].querySelectorAll("input.form-input");
        tableData["table6"] = {
        ...
        const filename = `form_data_${year}${month}${day}_${hours}${minutes}${seconds}.json`;
